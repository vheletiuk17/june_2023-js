...
//
//     divSimpsons.classList.add(`members`)
//
//     h1.innerText = `Name - ${familyMembers.name}`
//     p.innerText = `Surname - ${ familyMembers.surname}`
//     a.innerText = `Age - ${familyMembers.age}`
//     i.innerText = `Info - ${familyMembers.info}`
//     img.setAttribute('src', familyMembers.photo);
//     img.setAttribute('alt', familyMembers.name);
//
//     divSimpsons.append(h1,p,a,i,img)
//
